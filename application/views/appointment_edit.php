<?php $strings = unserialize(STRINGTABLE);?>			
			<div class="container_12">
				...
				<fieldset>
					<div class="grid_6">
						<input type="checkbox" name="appointment_done_edit" id="appointment_done_edit" />
						<label for="appointment_done">Erledigt</label>
					</div>
				</fieldset>
				<fieldset>
					<div class="grid_6"><label for="appointment_date"><?= $strings['appointment_edit.date']; ?></label><br/><input type="date" name="appointment_date_edit" id="appointment_date_edit" value="<?= date('Y-m-d', strtotime($appointment->appointment_datetime)) ?>" /></div>
				...
				<fieldset>
					<label for="appointment_location"><?= $strings['appointment_edit.location']; ?></label><input type="text" name="appointment_location" id="appointment_location" value="<?= $appointment->appointment_location ?>" />
				</fieldset>
				<fieldset>
